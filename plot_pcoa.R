...
#' @param col Colors for the points to be given to scale_color_manual(values=col)
#' @param shape Shapes for the points to be given to scale_shape_manual(values=shape)
